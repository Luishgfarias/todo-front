...
const TaskDetails = () => {
    ...
    return (
        <div className="flex flex-col gap-4 w-full">
            ...
            <p className="text-sm text-gray-500">Data de criação: {formatDateForDisplay(task.dataDeCriacao)}</p>
            <p className="text-sm text-gray-500">Data para conclusão: {formatDateForDisplay(task.dataParaConclusao)}</p>
